...
class __TwigTemplate_c49bd5ef621a21b509bb7e01331729d64d69e20c76562dd003290542cdb73e8b extends Twig_Template
{
    ...
    {
        $__internal_d4f591798dd96f59760366a6352c899c3a7427b48e96a71e4a32f17b8d4ddb3c = $this->env->getExtension("native_profiler");
        $__internal_d4f591798dd96f59760366a6352c899c3a7427b48e96a71e4a32f17b8d4ddb3c->enter($__internal_d4f591798dd96f59760366a6352c899c3a7427b48e96a71e4a32f17b8d4ddb3c_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "{# inline_template_start #}<div class=\"permission\"><span class=\"title\">{{ title }}</span>{% if description or warning %}<div class=\"description\">{% if warning %}<em class=\"permission-warning\">{{ warning }}</em> {% endif %}{{ description }}</div>{% endif %}</div>"));
        ...
        $__internal_d4f591798dd96f59760366a6352c899c3a7427b48e96a71e4a32f17b8d4ddb3c->leave($__internal_d4f591798dd96f59760366a6352c899c3a7427b48e96a71e4a32f17b8d4ddb3c_prof);
